...
import com.ueit.common.exception.CustomException;
...
import com.ueit.common.constant.CacheConstants;
...
import com.ueit.common.core.redis.RedisCache;
import com.ueit.common.exception.ServiceException;
import com.ueit.common.exception.user.CaptchaException;
import com.ueit.common.exception.user.CaptchaExpireException;
import com.ueit.common.exception.user.UserPasswordNotMatchException;
import com.ueit.common.utils.DateUtils;
import com.ueit.common.utils.MessageUtils;
import com.ueit.common.utils.ServletUtils;
import com.ueit.common.utils.StringUtils;
import com.ueit.common.utils.ip.IpUtils;
import com.ueit.framework.manager.AsyncManager;
import com.ueit.framework.manager.factory.AsyncFactory;
...
public class SysLoginService {
    ...
    public String loginByPhone(String phone, String password){
        ...
        if(StringUtils.isNull(user)){
            throw new CustomException("请管理员先添加用户");
        }
