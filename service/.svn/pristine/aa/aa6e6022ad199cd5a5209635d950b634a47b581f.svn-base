...
import com.ueit.system.domain.vo.ChooseDeptList;
...
import com.ueit.common.core.text.Convert;
...
import com.ueit.system.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService {
    ...
    /**
     * 根据当前登录用户部门id 查询该部门内所有状态正常的部门信息
     * @return 部门id 和 部门名称
     */
    @Override
    @DataScope(deptAlias = "d")
    public List<ChooseDeptList> selectChooseDeptList(SysDept sysDept) {
        return deptMapper.selectChooseDeptList(sysDept);
    }
     ...
     */
    @Override
    public List<ChooseDeptList> selectSchoolList() {
        return deptMapper.selectDeptListByParentId(100L);
    }
     ...
     */
    @Override
    public List<ChooseDeptList> selectBranchCourtsList(Long deptId) {
        return deptMapper.selectDeptListByParentId(deptId);
    }
