...
public interface RunInfoDataMapper {
     ...
     * @return 跑步信息
     */
    public RunInfoDataVo selectRunInfoById(Long id);
    ...
    public List<RunInfoDataVo> selectRunInfoList(RunInfoListDto runInfo);
     ...
     */
    @DataScope(deptAlias = "d")
    public Map selectRunInfoListSum(RunInfoListDto runInfo);
}
