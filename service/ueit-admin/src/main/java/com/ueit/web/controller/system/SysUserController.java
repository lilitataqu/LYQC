...
public class SysUserController extends BaseController {
    ...
    public TableDataInfo list(SysUser user) {
        startPage();
        user.setUserType(UserConstants.SYS_USER_TYPE);
    ...
    public TableDataInfo appUserList(SysUser user) {
        startPage();
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:user:list')" )
    @GetMapping("/teacherUserList" )
    public TableDataInfo teacherUserList(SysUser user) {
        String teacherRoleidString = configService.selectConfigByKey(SystemConfigKeyConstants.TEACHER_ROLEID);
        user.setRoleId(Long.parseLong(teacherRoleidString));
