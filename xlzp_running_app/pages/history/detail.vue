<template>
    <view>
        ...
        <!-- <view class="flex">
            <button class="flex-sub cu-btn bg-blue round lg margin-left margin-right padding margin-bottom" @tap="toShare">分享</button>
        </view> -->
        <view class="flex">
            <button class="flex-sub cu-btn bg-red round lg margin-left margin-right padding margin-bottom" @tap="delHistory">删除记录</button>
        </view>
    </view>
</template>
...
import {runInfoDelete, runInfoDetail} from '@/api/runInfo.js'
...
export default {
    ...
    methods: {
		...
		initPage(run_data){
			...
			let km_speed_data = run_data.kmSpeed;
			let altitude = run_data.altitudeSum;
			let altitude_data = run_data.altitude;
			let km_series = [];
			let km_categories = [];
			let altitude_series = [];
			let altitude_categories = [];
